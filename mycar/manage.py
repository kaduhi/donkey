...
def drive(cfg, model_path=None, use_joystick=False, use_chaos=False):
    ...
    def drive_mode(mode,
        ...
        if mode == 'user':
            ...
            angle = pilot_angle + user_angle

            #global base_angle
            #if user_angle == 0:
            #    base_angle = pilot_angle
            #    angle = pilot_angle
            #else:
            #    angle = base_angle + user_angle
    ...
    inputs = ['cam/image_array', 'angle', 'throttle', 'user/mode', 'timestamp']
...
def train(cfg, tub_names, new_model_path, base_model_path=None ):
    ...
    kl.train(train_gen,
             ...
             #use_early_stop=True, #default
             use_early_stop=False,
             min_delta=.0005, #default
             patience=5, #default
             #patience=25,
